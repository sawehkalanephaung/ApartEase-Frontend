      ...
      <div class="h-[calc(100vh-50px)] bg-primary py-[20px]">
        <div class="flex flex-col justify-between h-full px-[20px] space-y-[10px]">
          <div class="flex flex-col justify-between space-y-[10px]">
            ...
            <router-link to="/home" class="inline-flex relative items-center py-[10px] px-[10px] w-full text-sm font-medium rounded-md border-gray-200 hover:bg-gray-200 hover:text-gray-800 transition duration-400 ease-in-out" exact-active-class="active-link">
            ...
            <router-link to="/resident-list" class="inline-flex relative items-center py-[10px] px-[10px] w-full text-sm font-medium rounded-md border-gray-200 hover:bg-gray-200 hover:text-gray-800 transition duration-400 ease-in-out" exact-active-class="active-link">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-[25px] h-[25px] fill-current mr-2" >
           ...
           <div v-if="role === 'admin'  || role ==='Admin'" :class="{'active-link': isUserManagementActive}" class="relative"  @mouseover="showUserManagementDropdown = true" @mouseleave="showUserManagementDropdown = false">
              ...
              <transition name="fade">
                <div v-show="showUserManagementDropdown" class="absolute left-0 w-full mt-2 bg-white border border-gray-200 rounded-md shadow-lg z-10">
                  <router-link to="/user-list" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" exact-active-class="active-link">User</router-link>
                  <router-link to="/role-list" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" exact-active-class="active-link">Role</router-link>
                </div>
              </transition>
          </div>
          </div>
