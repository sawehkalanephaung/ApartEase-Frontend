      ...
      <div class="h-[calc(100vh-50px)] bg-emerald-600 py-[20px]">
        ...
        <div class="flex flex-col justify-between h-full px-[20px] space-y-[10px]">
          ...
          <div class=" flex flex-col justify-between space-y-[10px]">
            ...
            <router-link to="/dashboard" class="inline-flex relative items-center py-[10px] px-[10px] w-full text-sm font-medium rounded-md border-gray-200 hover:bg-gray-200 hover:text-gray-800  transition duration-400 ease-in-out">
