      ...
      <form class="mt-10" @submit.prevent="signup">
        <label class="block">
          ...
          <div class="block mt-6">
            <span for="role" class="block text-sm font-medium text-slate-700">User Role</span>
          <div class="mt-2">
            <select id="role" name="role" required v-model="role" class="mt-1 block w-full px-3 py-2 bg-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400
              focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-blue-500
            ">
