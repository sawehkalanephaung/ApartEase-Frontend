      ...
      <Form @submit="login" :validation-schema="schema" class="mt-10">
        <div class="mb-4">
          ...
          <Field
            ...
            type="text"
            name="username"
            class="block w-full px-3 py-2 mt-1 text-sm bg-white border rounded-md shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-blue-500 disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none"
