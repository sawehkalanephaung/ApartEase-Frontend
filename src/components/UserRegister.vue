  ...
  <div class="flex flex-col md:flex-row items-center justify-center h-screen px-6 bg-gray-200">
    ...
    <div class="w-full md:w-1/2 lg:w-2/5 p-6 bg-white rounded-md shadow-md">
      <div class="flex items-center justify-center">
        <span class="text-2xl font-semibold text-gray-700">Create an Account</span>
      </div>
      ...
      <form class="mt-10" @submit.prevent="register">
        ...
        <label class="block mt-6">
          <span class="block text-sm font-medium text-slate-700">Select Role</span>
          <select
            v-model="role"
            class="mt-1 block w-full px-3 py-2 bg-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400
                   focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-blue-500
